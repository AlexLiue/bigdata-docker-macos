...
/opt/run/confluent/bin/kafka-avro-console-consumer --bootstrap-server hadoop:9092 --property schema.registry.url=http://hadoop:8081 --topic test.db_gb18030_test.tbl_test --from-beginning
